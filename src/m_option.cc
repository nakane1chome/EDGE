...
static optmenuitem_t analogueoptions[] =
{
	...
	//	{OPT_Slider,   "Mouse Acceleration", NULL, 20,  &mouse_accel, NULL, NULL},
		...
		{OPT_Plain,    "",                   NULL, 0,  NULL, NULL, NULL},
		{OPT_Switch,   "Joystick Device 1", JoyDevs, 7,  &joystick_devices[0], NULL, "Verify index via console!"},
		{OPT_Switch,   "Joystick Device 2", JoyDevs, 7,  &joystick_devices[1], NULL, "Verify index via console!"},
